...
public class ReceptionistsForm extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(residentIDTF)
                            .addComponent(phoneTF)
                            .addComponent(dateTF)
                            .addComponent(genderCB, 0, 255, Short.MAX_VALUE)
                            ...
                            .addComponent(boardingTypeCB, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void addResidentbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addResidentbtnMouseClicked
        try {
           ...
           proxyBooking.Book(resident_Id, name, gender, phone, dateTF.getText(), roomNum, roomstype, boardingTypes, price);
