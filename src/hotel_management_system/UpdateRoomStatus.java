...
public class UpdateRoomStatus extends JFrame {
    ...
    public UpdateRoomStatus() throws SQLException {
        ...
        JLabel lblNewLabel = new JLabel("Resident ID:");
        ...
        try {
            ...
            while (rs.next()) {
                c1.addItem(String.valueOf(rs.getString("residentID")));
            }
        } catch (Exception e) {
        }
        ...
        JLabel lblCleanStatus = new JLabel("CleanStatus:");
        ...
        b1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    conn = connect_database.getInstance();
                    ResultSet rs2 = conn.getS().executeQuery("select * from room where roomNumber ="+txt_Room.getText());
                    while (rs2.next()) {
                        txt_Ava.setText(rs2.getString("availabilty"));
        ...
        btnUpdate.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) throws NumberFormatException {
                try {
                   conn = connect_database.getInstance();
                    String str = "update room set status = '" + txt_Status.getText()+ "' where roomNumber = " + txt_Room.getText();
