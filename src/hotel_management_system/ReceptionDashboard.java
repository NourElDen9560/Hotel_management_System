...
public class ReceptionDashboard  extends  JFrame implements Dashboard{
    
     public JButton addworker ,addroom;
    ...
    public void Draw_Dashboard(){
        ...
        btnNewCustomerForm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    Receptionists custom = new Receptionists();
        ...
        btnNewButton_2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    RoomDetails em = new RoomDetails();
                    em.setVisible(true);
                    setVisible(false);
                } catch (Exception e1) {
                    e1.printStackTrace();
...
//update.setVisible(true);
        ...
        btnNewButton_5.setBounds(10, 270, 200, 30);
        ...
        btnNewButton_6.setBounds(10, 310, 200, 30);
